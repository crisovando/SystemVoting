...
var HomeActions = function () {
  function HomeActions() {
    ...
    this.generateActions('getTwoCharacterSuccess', 'getTwoCharacterFail', 'voteFail');
  }

  _createClass(HomeActions, [{
    key: 'getTwoCharacters',
    value: function getTwoCharacters(winner, loser) {
      var _this = this;
      ...
      $.ajax({
        ...
        _this.actions.getTwoCharacters();
      }).fail(function (jqXhr) {
        _this.actions.voteFail(jqXhr.responseJSON.message);
      });
    }
  }]);
...
var NavbarActions = function () {
  function NavbarActions() {
    ...
    this.generateActions('updateOnlineUsers', 'updateAjaxAnimations', 'updateSearchQuery', 'getCharacterCountSuccess', 'getCharacterCountFail', 'findCharacterSuccess', 'findCharacterFail');
  }
...
var AddCharacterStore = function () {
  ...
  _createClass(AddCharacterStore, [{
    key: 'onCharacterSuccess',
    value: function onCharacterSuccess(successMessage) {
